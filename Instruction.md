...
3. Аналогічно створюємо та прив'язуємо інші цілі. Як тільки ціль прив'язана до розрахунку, вони повинні відразу з'явитися в інтерфейсі SkyHunter.
 
-----

## Интерфейс симулятора в SkyHunter
